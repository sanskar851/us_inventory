...
export default function SaleHistory({ setPage }) {
	...
	return (
		<>
			<form
				...
				method='post'
			>
				<span className='font-bold text-2xl text-black/70 mt-12 mb-5'>Sales History</span>
...
function SearchDialog({ setResult, openDialog, sales }) {
